package codova.plugin.myKad.MyKad;
 ...
 */
public class MyKad extends CordovaPlugin  implements MyIDListener, MyIDPermissionListener {
  ...
  public class MyReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      switch (action){
        case MyKad.INTENT_CALLER_ID:
          if(intent.getAction().equalsIgnoreCase(INTENT_CALLER_ID)) {
            intentCalled = true;
            JSONObject jsonObject = new JSONObject();

            try {
              jsonObject.put("ACTION", MyKad.INTENT_CALLER_ID);
  ...
  public void onStart() {
    ...
    intentFilter.addAction(MyKad.INTENT_CALLER_ID);
    intentFilter.addAction(MyKad.INTENT_MYKAD);
